      ...
      <div className="section-container">
        ...
        <div className="section-heading">
         ...
         <div
          ...
          className="program-nav sticky top-[55px] bg-pastel-gradient flex flex-wrap justify-center md:justify-center items-center gap-4 md:gap-8 mb-16 lg:mb-20 z-3000 border-b border-white/20 backdrop-blur-sm"
        >
          <a
            href="#daycare"
            data-tab="daycare"
        ...
        <div className="program-content-wrapper">
          ...
          <section id="daycare" className="program-content active">
            ...
            <div className="box-shadow-pink rounded-2xl p-8 md:p-12 lg:p-16 mb-20 lg:mb-28">
              <div className="grid lg:grid-cols-2 items-center gap-12 lg:gap-16">
                <div>
                  <h3 className="text-2xl color-gray-dark mb-5 font-extrabold md:text-3xl">
                    Our Ikigai Approach
                  </h3>
                  <p className="color-gray-light">
                    Inspired by the Japanese philosophy of "a reason for being,"
                    our daycare program is built around four core pillars. We
                    create a balanced, nurturing environment that helps children
                    find joy and purpose in their daily activities.
                  </p>
                </div>
            ...
            {/* A Day at Ikigai */}
            <div className="max-w-4xl mx-auto mb-18 lg:mb-28">
              <div className="text-center mb-12">
                <h3 className="text-2xl color-gray-dark mb-3 font-extrabold md:text-3xl">
                  A Day at Ikigai
                </h3>
                <p className="color-gray-light">
                  A glimpse into our daily rhythm of joyful learning, play, and
                  care.
                </p>
              </div>
              <div>
                <div className="timeline-item">
                  ...
                  <p className="color-gray-light text-sm">
                    A warm welcome followed by child-led exploration and social
                    interaction.
                  </p>
                </div>
                <div className="timeline-item">
                ...
                <div className="timeline-item">
                  ...
                  <p className="color-gray-light text-sm">
                    Fresh air and fun activities to develop large muscle groups
                    and coordination.
                  </p>
                </div>
                <div className="timeline-item">
            ...
            <div className="max-w-4xl mx-auto mb-20 lg:mb-28">
              <div className="text-center mb-14">
                <h3 className="text-3xl color-gray-dark mb-3 font-extrabold">
                  Core Focus Areas
                </h3>
                <p className="color-gray-light">
              ...
              <div className="accordion-container">
                  ...
                  <div className="accordion-content">
                    <div className="accordion-content-inner pt-8 text-ikigai-gray leading-relaxed">
                      <p className="color-gray-light text-sm pt-3">
                        We believe good habits build great lives. Our program is
                        thoughtfully designed to nurture essential routines like
                        daily discipline, personal hygiene, respectful
                ...
                <div className="accordion-item">
                  ...
                  <div className="accordion-content">
                    <div className="accordion-content-inner pt-6 text-ikigai-gray leading-relaxed">
                      <p className="color-gray-light text-sm pt-3">
                        Strong social skills are the cornerstone of a confident
                        and compassionate individual. We create daily
                        opportunities for children to connect, collaborate, and
                        grow through group activities, role-play, and creative
                        collaborations, helping them build meaningful
                        connections.
                      </p>
                    </div>
                  </div>
                ...
                <div className="accordion-item">
                  ...
                  <div className="accordion-content">
                    <div className="accordion-content-inner pt-6 text-ikigai-gray leading-relaxed">
                      <p className="color-gray-light text-sm pt-3">
                        Understanding oneself is as important as learning about
                        the world. We nurture a child's sense of identity,
                        emotions, and self-worth through self-discovery
                        activities, choice-making, and mindfulness, building a
                  ...
                  <div className="accordion-content">
                    <div className="accordion-content-inner pt-6 text-ikigai-gray leading-relaxed">
                      <p className="color-gray-light text-sm pt-3">
                        ...
                        wonders of our Earth and the importance of caring for it
                        through fun lessons, nature walks, and mini
            ...
            <div className="mt-8 text-center">
              <a
                href="pages/daycare.html"
                className="inline-block px-5 text-color-white py-3 transition-transform transform hover:scale-105 haptic-feedback playful-btn"
              >
          ...
          <section id="schooling" className="program-content">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-20 lg:mb-28">
              <div className="neumorphic-gradient-card-green p-8 text-center">
                ...
                <h3 className="text-2xl color-gray-dark mt-5 font-extrabold md:text-3xl">
                  Pre-Play
                </h3>
                <p className="color-gray-light">
                  (1.5 – 2.5 years)
                ...
                <p className="color-gray-dark mt-4">
                  ...
                  routines, and sensory exploration through music, movement, and
                  playful interaction.
                </p>
              </div>
              <div className="neumorphic-gradient-card-green  text-center">
                ...
                <p className="color-gray-dark mt-4">
                  ...
                  concepts like colors, shapes, and early social skills through
              ...
              <div className="p8 neumorphic-gradient-card-green  text-center">
                ...
                <p className="color-gray-dark mt-4">
                  ...
                  structure, focusing on pre-reading, pre-writing, numeracy, and
            ...
            <div className="mt-8 text-center">
              <a
                href="pages/schooling.html"
                className="inline-block text-white font-semibold px-8 py-3 rounded-full transition-transform transform hover:scale-105 haptic-feedback playful-btn"
              >
          ...
          <section id="parenting" className="program-content">
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center mb-10">
              <div className="glass p-8 md:p-12 rounded-2xl shadow-xl">
                ...
                <p className="color-gray-dark my-4">
                  ...
                  and fostering your child's emotional well-being. Connect with
                  fellow parents and our expert educators to navigate the
              ...
              <div className="glass p-8 md:p-12 rounded-2xl shadow-xl">
                ...
                <p className="color-gray-dark my-4">
                  Strengthen your bond and create lasting memories in our guided
                  discovery sessions. These activities are designed to help you
                  and your child explore, create, and learn together, uncovering
                  your shared passions and deepening your connection through the
                  Ikigai philosophy.
                </p>
                <a href="#" className="color-dark-purple text-sm font-bold">
                  Learn More &rarr;
            ...
            <div className="mt-8 text-center">
              <a
                href="pages/parenting-program.html"
                className="inline-block text-white font-semibold px-8 py-3 rounded-full transition-transform transform hover:scale-105 haptic-feedback playful-btn"
              >
          ...
          <section id="short-programs" className="program-content">
            <div className="section-heading">
              ...
              <p className="text-lg text-ikigai-gray">
                Focused, flexible, and fun-filled programs designed to give your
                child a developmental boost.
              </p>
            </div>
            <div className="grid lg:grid-cols-2 items-center gap-12 lg:gap-20 mb-10">
...
/>
              ...
              <div className="lg:order-1">
                <p className="color-gray-light">
                  For Ages 1.5 - 2.5 Years
                </p>
                <h3 className="text-2xl color-gray-dark font-extrabold md:text-3xl">
                  Step Up to Shine
                </h3>
                <p className="color-gray-light py-4">
                  This program is a gentle introduction to a world of wonder for
                  our youngest learners. We focus on nurturing your toddler's
                  budding curiosity and building a strong foundation for their
                  developmental journey. Through sensory play, music, movement,
                  and tender guidance, we help them explore their environment,
                  build trust, and take their first confident steps toward
                  shining brightly.
                </p>
                <a
                  href="#"
...
/>
              ...
              <div>
                ...
                <p className="color-gray-light py-4">
                  ...
                  formal schooling with our dedicated prep program. We focus on
                  building the essential academic and social skills needed for
                  the classroom, such as letter and number recognition,
